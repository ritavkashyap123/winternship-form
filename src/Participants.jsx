...
const Participants = () => {
  ...
  return (
    <>
      {rows.length > 0 && (
        <Paper sx={{ width: "auto", overflow: "hidden", padding: "10px", margin: "1rem", borderRadius: "20px" }}>
                  ...
                  .map((row) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{row.leadCurrentYear}</TableCell>
                        <TableCell align="left">{row.leadInterest}</TableCell>
                        <TableCell align="left">{row.leadPriorWork}</TableCell>
                        <TableCell align="left">{row.leadCurrentWork}</TableCell>
                        <TableCell align="left">{row.leadCategory}</TableCell>
                        ...
                        <TableCell align="left">{row.mem2CurrentYear}</TableCell>
                        <TableCell align="left">{row.mem2Interest}</TableCell>
                        <TableCell align="left">{row.mem2PriorWork}</TableCell>
                        <TableCell align="left">{row.mem2CurrentWork}</TableCell>
                        ...
                        <TableCell align="left">{row.mem3CurrentYear}</TableCell>
                        <TableCell align="left">{row.mem3Interest}</TableCell>
                        <TableCell align="left">{row.mem3PriorWork}</TableCell>
                        <TableCell align="left">{row.mem3CurrentWork}</TableCell>
